...
async def startup():
    ...
    if await db.leaders.count_documents({}) == 0:
        await db.leaders.insert_many([
            ...
            {
                "id": str(uuid.uuid4()),
                "name_hi": "एडवोकेट शिव शंकर सोनी",
                "name_en": "Advocate Shiv Shankar Soni",
                "role_hi": "राष्ट्रीय युवा अध्यक्ष",
                "role_en": "National Youth President",
                "bio_hi": "बुलंद भारत पार्टी के राष्ट्रीय युवा अध्यक्ष। पेशे से अधिवक्ता। युवाओं को रोज़गार, कौशल विकास और राष्ट्र-निर्माण से जोड़ने के अग्रदूत।",
                "bio_en": "National Youth President of Buland Bharat Party. Advocate by profession. Champion of connecting youth to employment, skill development and nation-building.",
                "image": "https://customer-assets.emergentagent.com/job_bharat-converter-hub/artifacts/y1jzb3ni_image.png",
                "order": 6,
            },
        ])
