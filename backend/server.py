...
async def startup():
    ...
    if await db.leaders.count_documents({}) == 0:
        await db.leaders.insert_many([
            {
                "id": str(uuid.uuid4()),
                "name_hi": "श्री कुणाल कान्त शर्मा",
                "name_en": "Shri Kunal Kant Sharma",
                "role_hi": "राष्ट्रीय अध्यक्ष",
                "role_en": "National President",
                "bio_hi": "बुलंद भारत पार्टी के संस्थापक एवं राष्ट्रीय अध्यक्ष। एकता, सौहार्द, और भ्रष्टाचार-मुक्त भारत के प्रबल पैरोकार। 'न खाऊँगा, न खाने दूँगा' को ज़मीनी हकीकत बनाने का संकल्प।",
                "bio_en": "Founder and National President of Buland Bharat Party. Strong advocate of unity, harmony and a corruption-free India.",
                "image": "https://customer-assets.emergentagent.com/job_bharat-converter-hub/artifacts/cbst5tj7_image.png",
                "order": 1,
            },
            {
                "id": str(uuid.uuid4()),
        ...
        await db.news.insert_many([
            {
                ...
                "content_hi": "बुलंद भारत पार्टी के फरीदाबाद लोकसभा प्रत्याशी श्री सत्य देव यादव ने पार्टी के राष्ट्रीय अध्यक्ष श्री कुणाल कान्त शर्मा और अनेक पदाधिकारियों की उपस्थिति में चुनाव आयोग में अपना नामांकन दाखिल किया। नामांकन के समय बड़ी संख्या में कार्यकर्ता उपस्थित रहे। पार्टी का चुनाव चिन्ह 'गैस सिलेंडर' है।",
                "content_en": "Buland Bharat Party's Faridabad Lok Sabha candidate Shri Satya Dev Yadav filed his nomination at the Election Commission in the presence of National President Shri Kunal Kant Sharma and several office bearers. A large number of workers were present. The party's election symbol is 'Gas Cylinder'.",
                "category": "नामांकन",
            ...
            },
            {
                ...
                "excerpt_hi": "राष्ट्रीय अध्यक्ष श्री कुणाल कान्त शर्मा ने कार्यकर्ता बैठक में 'पहले भारतीय' की भावना को आगे बढ़ाने पर ज़ोर दिया।",
                "excerpt_en": "National President Shri Kunal Kant Sharma emphasized the spirit of 'Indian First' at the workers' meeting.",
